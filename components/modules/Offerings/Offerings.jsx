              ...
              <div className="offerings__item-about">
                ...
                <div className="offerings-about__contacts">
                  <div className="offerings-contacts-box">
                    ...
                    <a className='profile-contact tg' href="">Telegram</a>
                    <a className='profile-contact ws' href="">WhatsApp</a>
                    <a className='profile-contact vb' href="">Viber</a>
                    <a className='profile-contact zm' href=""></a>
                  </div>
                  <div className="offerings-about-right">
                    <button className="offerings-about-btn btn-reset">
                      Написать в чат
                      <span className="blue-counter">5</span>
                    </button>
